...
> **Version:** 0.4
> **Status:** Draft toàn platform; US-004 domain contract Approved/Build-ready cho EC2 test
> **Owner:** Domain Architecture / Business Analysis (cá nhân: TBD)
> **Updated:** 2026-07-12
> **Approval:** US-004 profile — Product Owner delegated 2026-07-12; toàn platform/production TBD — Product Owner, Domain Owners, Architecture và Data Owner
...
| Risk, Issue, Change & Claim — BR-022, BR-031, BR-032; FR-098…105 | Roots: Risk, Issue, ChangeRequest, Claim. Entities: RiskIssueAction, ImpactAssessment, NoticeRecord. VO: Probability1To5, Impact1To5, ExposureBand/ScoringVersion, PackageScope, BaselineRef, ImpactSnapshotHash, ClauseRef. | Services: RiskScoring, ClosurePolicy, ChangeImpact, ApprovedChangeReader, ClaimEntitlement. Commands: Register/Assess/Treat/RequestCloseRisk, Materialize/Resolve/RequestCloseIssue, Add/VerifyAction, Create/Submit/DecideChange. Events: RiskOccurred, ActionOverdue, IssueResolved, ChangeApproved. Queries: scoped registers, summary/history, eligible approved changes/reverse baselines. | Risk khác Issue; tenant/project/package scope; exact one action parent; closure evidence/verified actions + independent actor; approved Change/source baseline/hash trước rebaseline và bất biến. Claim/Legal là separate dependency. SoR: PM/change; Legal entitlement. |
...
| History/async | DB-098 audit timeline và DB-102 domain event commit cùng business state; DB-103/105 xử lý notification idempotent |
...
| Approved result | Port chỉ trả immutable approvedAt/by, decisionVersion, sourceBaselineId, scheduleImpactSummary và impactSnapshotHash; denial phân biệt not-approved/baseline-mismatch/schedule-impact |
