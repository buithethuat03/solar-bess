...
> **Scope:** Các vấn đề chưa xác định hoặc quyết định xuyên artefact; gồm operational foundation/core US-003 đã deploy EC2 test, US-004 Approved/Build-ready và ranh giới full story/production Proposed; không thay thế ADR, BR/FR/NFR/SEC hoặc legal/technical approval tại tài liệu owner.
...
> **Version:** 0.6
> **Status:** Draft toàn platform; operational foundation/core US-003 Implemented/deployed EC2 test; US-004 Approved/Build-ready; production Proposed
> **Owner:** Product Owner / Product Operations (cá nhân: TBD)
> **Updated:** 2026-07-12
> **Approval:** Operational foundation EC2 test và US-003/US-004 profile Approved — Product Owner delegated; full story/toàn platform/production TBD — Steering/Product Owner và owner ghi trong từng dòng
...
| DB-101 ProjectSchedule; DB-105 Notification; DB-106 SavedView; DB-107 ReportJob; DB-108 AIUseCasePolicy; DB-109 AIRun; DB-110 AIProposal; DB-111 AIReview chỉ được reserve | Confirmed — Product Owner delegated 2026-07-11 | Giữ ID ổn định mà không mở scope US-003/022/023/031…037 | 07/15/ExecPlan | Chỉ feature ExecPlan riêng được tạo table/API |
...
| DB-105 được concretize riêng schedule-alert projection cho US-003; notification preference/digest còn thuộc US-022 | Confirmed — Product Owner delegated 2026-07-11 | Cho phép đóng AC-013 mà không ngầm mở toàn Notification Center | 07/15/US-003 ExecPlan | US-022 ExecPlan |
...
| DB-105…107 supporting projection physical schema/retention | IDs reserved; feature design deferred | No new SoR/table in foundation; rebuildable semantics | US-022/023 ExecPlan |
...
| Hosted CI bị ghi nhận giả là implemented | Medium | High | docs ghi pass nhưng không có workflow/artifact | Platform/QA | Giữ Planned, chỉ ghi exact run evidence |
