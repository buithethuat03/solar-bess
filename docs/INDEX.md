...
| 10 | [08 — API Specification](./08-api-specification.md) | API conventions and 164-operation catalog | Draft; implemented slice plus canonical Swagger publication local | 1.4 / 2026-07-18 | 04–07 | API/Domain/Security/Integration/QA |
...
| 16 | [13 — Test Strategy](./13-test-strategy.md) | Test levels and 233 TEST scenarios | Draft; US-004 pre-push gate and Swagger TEST-197 local Pass; TEST-014…017 Partial | 1.6 / 2026-07-18 | 04/08–12 | QA, Security, SRE, OT, business |
| 17 | [14 — DevOps and Deployment](./14-devops-and-deployment.md) | Environments, CI/CD, rollout/recovery/release | Draft; Swagger env/image/Nginx public worktree smoke Pass, commit CI/CD release Pending | 1.0 / 2026-07-18 | 06/09/13 | Platform, SRE, Security, QA |
...
| OpenAPI | 3.1.0 document version 0.9.0; 164/164 unique x-api-id và 164/164 unique operationId; 33 implemented markers gồm API-008/036/038/143…164; close-out Redocly validation được chạy lại; canonical runtime Swagger `/api/docs/` và YAML `/api/docs/openapi.yaml` local TEST-197 Pass |
...
| Swagger publication validation | 2026-07-18 pre-push root lint/type/build/OpenAPI Pass; unit API 15/55 + Web 20/55 + Worker 12/61 = 171; exact isolated full integration API 8/50 + Worker 3/11 = 61; production-image/Nginx public worktree UI/assets/YAML smoke Pass. Commit CI/CD Pending. |
