...
> **Scope:** Governance, baseline, docs/00…17, OpenAPI và changelog; gồm US-004 local implementation với E2E UI journey đã Pass, US-022 notification inbox (API-135/136) và US-015 approval workflow engine (API-106…112) Implemented, canonical Swagger runtime publication và EC2 self-hosted CI/CD profile; full story/production validation còn tiếp tục.
> **Source:** [AGENTS.md](../AGENTS.md), [Documentation Plan](./00-documentation-plan.md), [Program ExecPlan](../.agent/execplans/2026-07-11-platform-delivery-program.md), [CI/CD ExecPlan](../.agent/execplans/2026-07-12-main-self-hosted-cicd.md), [US-022 Notification ExecPlan](../.agent/execplans/2026-07-26-notification-inbox-us022.md), [US-015 Workflow Engine ExecPlan](../.agent/execplans/2026-07-26-workflow-engine-us015.md).
> **Version:** 2.1
> **Status:** Draft
...
| 10 | [08 — API Specification](./08-api-specification.md) | API conventions and 164-operation catalog | Draft; current/design Swagger split and 51 runtime markers deployed EC2 test | 1.5 / 2026-07-18 | 04–07 | API/Domain/Security/Integration/QA |
| 11 | [OpenAPI 3.1](./openapi/openapi.yaml) | Machine-readable API contract with 164 x-api-id | Machine-readable Draft; 51 implemented markers; Redocly validation required at close-out | 0.9.1 / 2026-07-18 | 08 | API tooling/QA/consumers |
...
| 16 | [13 — Test Strategy](./13-test-strategy.md) | Test levels and 233 TEST scenarios | Draft; Swagger 51/164 split TEST-197 EC2 test Pass; TEST-014…017 Partial | 1.8 / 2026-07-18 | 04/08–12 | QA, Security, SRE, OT, business |
| 17 | [14 — DevOps and Deployment](./14-devops-and-deployment.md) | Environments, CI/CD, rollout/recovery/release | Draft; dual Swagger SHA release deployed/verified EC2 test | 1.2 / 2026-07-18 | 06/09/13 | Platform, SRE, Security, QA |
| 18 | [15 — Traceability Matrix](./15-traceability-matrix.md) | End-to-end chain, gap and contradiction audit | Draft; 51 runtime API markers reconciled, acceptance remains test-specific | 1.6 / 2026-07-18 | 01–14 | PO, BA, QA, Architecture |
...
| OpenAPI | 3.1.0 document version 0.9.1; 164/164 unique x-api-id và operationId; 51 controller-backed implemented markers; `/api/docs/` current view và `/api/design-docs/` complete design view EC2 TEST-197 Pass |
...
| Swagger publication validation | 2026-07-18 root lint/type/build/OpenAPI Pass; 51/51 business controller routes reconciled; unit API 15/56 + Web 20/55 + Worker 12/61 = 172; exact isolated full integration API 8/50 + Worker 3/11 = 61; focused dual-view 9/9; GitHub Actions `29633937535` CI/deploy Pass; immutable release `a54f487…` healthy và public UI/CSS/init/YAML, CSP/no-store, exact 51/164 post-deploy smoke Pass. |
...
| 1.7 | 2026-07-18 | Codex | Ghi canonical Swagger/OpenAPI runtime publication, env/image/Nginx/deploy-smoke profile và TEST-197 local evidence | Không đổi API count/business scope; UI/YAML local Pass, public commit deploy Pending tại thời điểm ghi |
| 1.8 | 2026-07-18 | Codex | Tách current/design Swagger, reconcile 18 missing implementation markers và OpenAPI 0.9.1/Trace 1.6 | Không đổi API/requirement/business scope; current view 51, design view 164 |
| 1.9 | 2026-07-18 | Codex | Ghi GitHub Actions 29633937535, immutable SHA a54f487 và post-deploy public validation cho dual Swagger | Không đổi scope; EC2 test CI/deploy/runtime verification Pass |
