...
| 10 | [08 — API Specification](./08-api-specification.md) | API conventions and 164-operation catalog | Draft; current/design Swagger split and 51 runtime markers local | 1.5 / 2026-07-18 | 04–07 | API/Domain/Security/Integration/QA |
...
| 16 | [13 — Test Strategy](./13-test-strategy.md) | Test levels and 233 TEST scenarios | Draft; Swagger 51/164 split TEST-197 local Pass; TEST-014…017 Partial | 1.7 / 2026-07-18 | 04/08–12 | QA, Security, SRE, OT, business |
| 17 | [14 — DevOps and Deployment](./14-devops-and-deployment.md) | Environments, CI/CD, rollout/recovery/release | Draft; dual Swagger Nginx/deploy-smoke profile local, commit release Pending | 1.1 / 2026-07-18 | 06/09/13 | Platform, SRE, Security, QA |
...
| OpenAPI | 3.1.0 document version 0.9.1; 164/164 unique x-api-id và operationId; 51 controller-backed implemented markers; `/api/docs/` current view và `/api/design-docs/` complete design view local TEST-197 Pass |
...
| Swagger publication validation | 2026-07-18 split pre-push root lint/type/build/OpenAPI Pass; 51/51 business controller routes reconciled; unit API 15/56 + Web 20/55 + Worker 12/61 = 172; exact isolated full integration API 8/50 + Worker 3/11 = 61; focused dual-view 9/9; production-image/Nginx local/public worktree UI/CSS/init/YAML, CSP/no-store và exact 51/164 smoke Pass. Commit CI/CD Pending. |
